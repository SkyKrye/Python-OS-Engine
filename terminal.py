...
- info""")
        ...
        cmdselector=input("""---LEGACY COMMAND---
---use the better func mode with regvar---
what mode do you want to replace your cmd with? -
- cmd
- rawprint
- func
mode - """)
...
#web
        ...
        serverPrompt = input("which store server to connect to? -\n- web (direct) \n- dl (dl) -\n ")
        if serverPrompt == 'web':
            print("""web.smpverge.cf pyTer store -
- py.py
- extras
""")
        elif serverPrompt == 'dl':
            print("""dl.smpverge.cf pyTer store -
- py.py
- extras
""")
        else:
            print('the store server: '+serverPrompt+' does not exist')

    elif cmd == 'web.install':
        serverInstall = input('install - ')
        url = "http://web.smpverge.cf/pyTer/"+serverInstall
...
#custom commands
        ...
        print(f"""custom command creator -
slots -
- {command1}
- {command2}
- {command3}""")
    elif cmd == 'customCommand.create':
        input('choose command slot - ')
